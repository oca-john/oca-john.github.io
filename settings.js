...
const translations = {
    en: {
        ...
        // About
        aboutDesc: "I have an interdisciplinary research background spanning biology, theoretical modeling, and computational algorithms, with long-term work on experimental optimization, data analysis, and model construction for complex life-system problems. During my undergraduate and master's training, I conducted research in microbiology, plant pathology, and cell biology, mainly using orthogonal design, response surface optimization, and bioinformatics methods for experimental design and data-assisted analysis. During my doctoral training, I shifted toward biological theoretical modeling and data-driven research, exploring computational algorithms for practical biomedical problems. As a postdoctoral researcher, I have entered neuroscience and optical brain-computer interfaces, focusing on closed-loop control through needs analysis, theoretical modeling, and dynamical network model construction. This trajectory has shaped my interdisciplinary research capability grounded in biological problem understanding and centered on algorithmic modeling and data-driven methods. In my postdoctoral work, I plan to further focus on closed-loop control in optical brain-computer interfaces, integrating needs analysis, theoretical modeling, and dynamical network model construction to connect neural signal reading, decoding, optical writing, and feedback regulation in a unified research framework.",
    ...
    "zh-CN": {
        ...
        aboutDesc: "本人具有生物学、理论建模与计算机算法交叉研究背景，长期围绕复杂生命系统问题开展实验优化、数据分析与模型构建工作。本科及硕士阶段分别在微生物学、植物病理学和细胞生物学领域开展研究，主要运用正交设计、响应面优化及生物信息学方法进行实验设计与数据辅助分析。博士阶段转向生物理论建模与数据驱动研究，探索以计算机算法解决生物医学实际问题。博士后阶段进入神经科学与光学脑机接口领域，围绕闭环控制问题开展需求分析、理论建模和动力学网络模型构建，形成了以生物学问题理解为基础、以算法建模和数据驱动方法为核心的跨学科研究能力。后续研究计划将进一步聚焦光学脑机接口中的闭环控制问题，结合需求分析、理论建模与动力学网络模型构建，形成连接神经信号读取、解码、光学写入与反馈调控的一体化研究框架。",
    ...
    "zh-TW": {
        ...
        aboutDesc: "本人具有生物學、理論建模與計算機算法交叉研究背景，長期圍繞複雜生命系統問題開展實驗優化、數據分析與模型構建工作。本科及碩士階段分別在微生物學、植物病理學和細胞生物學領域開展研究，主要運用正交設計、響應面優化及生物信息學方法進行實驗設計與數據輔助分析。博士階段轉向生物理論建模與數據驅動研究，探索以計算機算法解決生物醫學實際問題。博士後階段進入神經科學與光學腦機接口領域，圍繞閉環控制問題開展需求分析、理論建模和動力學網絡模型構建，形成了以生物學問題理解為基礎、以算法建模和數據驅動方法為核心的跨學科研究能力。後續研究計劃將進一步聚焦光學腦機接口中的閉環控制問題，結合需求分析、理論建模與動力學網絡模型構建，形成連接神經信號讀取、解碼、光學寫入與反饋調控的一體化研究框架。",
